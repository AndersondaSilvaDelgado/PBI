            ...
            public void onClick(View v) {
                ...
                if (!editTextPadrao.getText().toString().equals("")) {
                    ...
                    if (pbiContext.getMecanicoCTR().verMatricColab(Long.parseLong(editTextPadrao.getText().toString()))) {
                        ...
                        pbiContext.getMecanicoCTR().atualBoletimSApont();
                        pbiContext.getMecanicoCTR().atualSalvarBoletim(pbiContext.getMecanicoCTR().getColab(Long.parseLong(editTextPadrao.getText().toString())));
